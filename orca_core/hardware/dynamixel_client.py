...
DEFAULT_POS_SCALE = 2.0 * np.pi / 4096  # 0.088 degrees   位置缩放：4096单位对应2π弧度
# See http://emanual.robotis.com/docs/en/dxl/x/xh430-v210/#goal-velocity
DEFAULT_VEL_SCALE = 0.229 * 2.0 * np.pi / 60.0  # 0.229 rpm   速度缩放：0.229 rpm转弧度/秒
DEFAULT_CUR_SCALE = 1.34   #电流缩放因子
